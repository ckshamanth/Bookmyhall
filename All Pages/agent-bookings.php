						...
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow" src="https://i.ibb.co/X2xnr3K/Avatar-Profile-Vector.png" alt="Avatar-Profile-Vector" border="0">
								</div>
								<div>
									<a class="h6 mt-2 mt-sm-0" href="#">Admin</a>
									<p class="small m-0">admin@123</p>
								</div>
							</div>
						</li>
